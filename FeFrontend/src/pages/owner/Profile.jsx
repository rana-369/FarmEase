        ...
        >
          ...
          {!isEditing && (
            <motion.button
              ...
              className="px-6 py-3 rounded-xl font-semibold flex items-center gap-2 relative overflow-hidden"
              style={{ 
                background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 50%, #1d4ed8 100%)',
                color: '#ffffff'
              }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          >
            ...
            >
              ...
              <span 
                className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold relative"
                style={{ 
          ...
          >
            ...
            >
              <div className="absolute inset-0 opacity-30" style={{ background: 'radial-gradient(circle at 100% 0%, rgba(59, 130, 246, 0.05) 0%, transparent 50%)' }} />
