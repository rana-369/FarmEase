      ...
      <div className="max-w-4xl mx-auto space-y-10">
        <div className="flex items-center justify-between">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            <h1 className="text-4xl font-bold mb-2" style={{ color: '#ffffff' }}>Your Notifications</h1>
            <p className="text-lg" style={{ color: '#a1a1a1' }}>Stay updated with your rental status and platform alerts</p>
          </motion.div>
          <button 
        ...
        <div className="space-y-4">
          {notifications.length === 0 ? (
            <div className="text-center py-32 rounded-3xl" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px dashed rgba(255, 255, 255, 0.1)' }}>
              ...
              <h3 className="text-2xl font-bold" style={{ color: '#ffffff' }}>No notifications yet</h3>
              <p style={{ color: '#a1a1a1' }}>We'll notify you when your rental status changes.</p>
            </div>
          ) : (
