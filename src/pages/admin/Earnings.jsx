...
import { FiDollarSign, FiTrendingUp, FiArrowUpRight, FiArrowDownRight, FiCalendar, FiFilter, FiDownload } from 'react-icons/fi';
            ...
            {revenueData.map((data, index) => (
              <div key={data.month} className="group">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="font-bold text-lg" style={{ color: '#ffffff' }}>₹{data.revenue.toLocaleString()}</span>
                </div>
